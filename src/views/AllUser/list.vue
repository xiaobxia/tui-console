<template>
  <div class="app-container">
    <div style="font-size: 20px;padding: 20px;">
      <span style="margin-right: 15px">今日A料:{{ todayInfo.dayR }}</span>
      <span style="margin-right: 15px">今日现金贷A料:{{ todayInfo.dayRX }}</span>
      <span style="margin-right: 15px">今日贷超A料:{{ todayInfo.dayRD }}</span>
